...
def setup(game):
    ...
    game.objects["Poly0"] = SquarePolygon(game.stages["World"], game.objects["Point0"], game.objects["Point2"],
                                          game.objects["Point1_"], game.objects["Point3_"], (0, 0, 255))
    ...
    game.objects["Line02"] = Line(game.stages["World"], game.objects["Point0"], game.objects["Point2"], (200, 200, 200),
                                  20)
    ...
    game.objects["Line2"] = Line(game.stages["World"], game.objects["Point2"], game.objects["Point2_"], (200, 200, 200),
                                 20)
...
def loop(game):
    ...
    if math.sqrt(dx ** 2 + dy ** 2) > 100:
        game.objects["Duck"].dinamic_object.Fres = game.objects["Duck"].dinamic_object.Fres + Vector2D(
            ...
            math.cos((-game.objects["Duck"].dir + 90) / 180 * math.pi)) * MOVE_POWER
